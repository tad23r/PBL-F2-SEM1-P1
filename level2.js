...
const levels = [
        {
            ...
            message: "Level 2: F Key's Hidden Use"
        },
        {
            spawn: { x: 100, y: 460 },
            platforms: [
                { x: 350, y: -200, width: 170, height: 2000, type: "phase"},
        ...
        },
        {
            ...
            orbs: [
                { x: 400, y: 460, radius: 10, collected: false, offset: 0 }
            ],
        },
        {
            spawn: { x: 100, y: 460 }, 
            platforms: [
                { x: 400, y: -200, width: 120, height: 2000, type: "death"},
                { x: 0, y: 500, width: 960, height: 40 },
                { x: -70, y: -200, width: 120, height: 2000 },
                { x: 900, y: -200, width: 120, height: 2000 },
            ],
        ...
        },
        {
            spawn: { x: 100, y: 460 }, 
            platforms: [
                { x: 200, y: -200, width: 120, height: 2000, type: "death"},
                { x: 490, y: 250, width: 250, height: 20 },
                { x: 490, y: 270, width: 20, height: 250 },
                { x: 600, y: 0, width: 20, height: 250, type: "phase" },
                { x: 650, y: 350, width: 250, height: 20 },
                { x: 0, y: 500, width: 960, height: 40 },
                { x: -70, y: -200, width: 120, height: 2000 },
                { x: 900, y: -200, width: 120, height: 2000 },
            ],
            ...
            orbs: [
                { x: 400, y: 400, radius: 10, collected: false, offset: 0 },
                { x: 550, y: 50, radius: 10, collected: false, offset: 0 },
                { x: 680, y: 200, radius: 10, collected: false, offset: 0 },
            ],
            spikes: [
                { x: 510, y: 490, width: 230, height: 10 },
                { x: 650, y: 340, width: 250, height: 10 },
            ],
        },
        {
            spawn: { x: 400, y: 460 },
